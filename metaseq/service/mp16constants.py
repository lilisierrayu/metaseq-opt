...
MODEL_SHARED_FOLDER = (
    "/shared/home/liliyu/cm3-code/saved_models"  #'/data/gpt-z/models/gptz/'
)
LOCAL_SSD = MODEL_SHARED_FOLDER
...
CHECKPOINT_FOLDER = os.path.join(MODEL_SHARED_FOLDER, "OPTMP16", "reshard")
# where to store them on SSD for faster loading
CHECKPOINT_LOCAL = os.path.join(LOCAL_SSD, "OPTMP16", "reshard", "reshard.pt")

LAUNCH_ARGS = [
    f"--model-parallel-size {MODEL_PARALLEL}",
    f"--distributed-world-size {TOTAL_WORLD_SIZE}",
    # "--task language_modeling",
    "--task language_modeling_inference_for_models_trained_with_streaming",
